...
if (-not $clipboard) {
    Write-Error "âŒ Clipboard is empty."
    exit 1
}
...
@"
**ðŸ›°ï¸ Tripwire Recon â€“ $system**
ðŸ“ Status: Contacts detected.

ðŸ“¡ D-Scan Intel:
$($matchedLines -join "`n")

ðŸ•“ Time: $timestamp
ðŸ§­ Scout: [YourNameHere]
"@
} else {
@"
**ðŸ›°ï¸ Tripwire Recon â€“ $system**
ðŸ“ Status: No targets of interest detected.

ðŸ“¡ D-Scan checked for:
$($targetPatterns -join ", ")
